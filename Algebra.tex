...
\end{exm}
%VL 21.11.2016
%Korrektur der COunter bis zum ergänzen der VL
\setcounter{subsection}{2}
\setcounter{thm}{14}
%VL 23.11.2016

$M=M_0\supsetneqq M_1\supsetneqq...\supsetneqq M_r=0$.\\
Dann ist $r$ die Länge der Jordan-Hölder Reihe, falls $M_{i-1}/M_i$ einfach ist.
\begin{satz} %5.14
	Je zwei JH-Reihen habe die selbe Läge.\\
	$l(M):=$ Länge einer JH-Reihe. $=\infty$, falls keine JH-Reihe existiert.\\
	Falls $l(M)<\infty$, so kann jede Kompositions-Reihe zu einer JH-Reihe ergänzt werden.
\end{satz}
\begin{proof}
	(für Moduln, für Gruppen analog)\\
	Sei $M$ ein $R$-Modul. Setze $l(M):=\inf\{\text{Längen von JH-Reihene von $M$}\}\in \N_0\cup\{\infty\}$
	\begin{enumerate}
